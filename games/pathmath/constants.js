...
const pathMathGoalContainer = document.getElementById(
...
const startScreen = document.getElementById("pathmath-start-screen");
const endScreen = document.getElementById("pathmath-end-screen");
const scoreBreakdown = document.getElementById("pathmath-score-breakdown");
const startButton = document.getElementById("pathmath-start-button");
const restartButton = document.getElementById("pathmath-restart-button");
const shareButton = document.getElementById("pathmath-share-button");

const pathMathGridBackground = document.getElementById(
...
const GAME_DURATION_MS = 1000 * 60 * 3;
