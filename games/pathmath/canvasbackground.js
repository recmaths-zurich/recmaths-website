...
function drawPathOnBackground(cellGrid, pathVectors) {
  ...
  context.clearRect(
    0,
    0,
    pathMathGridBackground.width,
    pathMathGridBackground.height,
  );

  context.strokeStyle = darkenHexColor(
    getComputedStyle(pathMathGlobal).getPropertyValue("--mark-color"),
    -20,
  );
